...
def _build_and_store(design: dict[str, Any], overrides: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    result = builder.build_design(design, params)
    ...
    return {
        ...
        "has_step": result.step_path is not None,
        "params": params,
    }
...
def design_page(request: Request, design_id: str):
    ...
    return templates.TemplateResponse(
        request,
        "design.html",
        {"design": design, "report": result["report"], "has_step": result["has_step"]},
    )
